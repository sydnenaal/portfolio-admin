...
export const SET_MESSAGES_SEARCH_FOR = "MESSAGES/SET_MESSAGES_SEARCH_FOR";
...
export const SET_IS_DENSE = "PROJECTS/SET_IS_DENSE";
export const SET_SEARCH_FOR = "PROJECTS/SET_SEARCH_FOR";
...
export const SET_REQUESTS_STACK = "REQUEST/SET_REQUEST_STACK";
export const SET_USER_DATA = "USER/SET_USER_DATA";
export const SET_CONTACTS = "USER/SET_CONTACTS";
